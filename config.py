phone = '3423423423423'  # Номер киви
qiwi_token = '32423423423423423423423'  # https://qiwi.com/api
telegram_token = '6317766257:AAFXHXHcSuInpwhBxNJ3_EsaTrawMCecMW4'  # Бота создавать через @Botfather
easyliker_token = 'EbkB4q0A1kw5RcqYYr373UAuKpc40iH7'  # Токен получать тут https://easyliker.ru/profile/api

admins = [5661436628]  # список адинов через запятую
...
supports = 'TG VK: vk.com/id0'  # контакты тех.поддержки
